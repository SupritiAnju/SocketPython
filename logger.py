...
class Logger(object):
    ...
    def __init__(self, debug=0, mode=0, log_file=None, level=logging.INFO):
        """
        ...
        if log_file:
            ...
            homeDir = os.getcwd()
            logs_dir = "logs/"#config_json["_logs"]
...
class CustomRotatingFileHandler(TimedRotatingFileHandler):
    def __init__(self, filename, when='midnight', backup_count=1, max_bytes=50000000):  # 50 MB
        """
